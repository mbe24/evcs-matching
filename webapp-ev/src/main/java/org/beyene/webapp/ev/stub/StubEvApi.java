...
class StubEvApi implements EvApi {

    private static final Log logger = LogFactory.getLog(StubEvApi.class);
    ...
    @Override
    public void init() {
        logger.info("org.beyene.webapp.ev.stub.StubEvApi.init");
    }
    ...
    @Override
    public void close() {
        logger.info("org.beyene.webapp.ev.stub.StubEvApi.close");
    }
}
